const u16 gFacilityClassToPicIndex[] =
{
    ...
    // Custom Front Sprites
    [FACILITY_CLASS_GARY] = TRAINER_PIC_GARY,
    [FACILITY_CLASS_LANCE] = TRAINER_PIC_LANCE,
    [FACILITY_CLASS_CYNTHIA] = TRAINER_PIC_CYNTHIA,
    [FACILITY_CLASS_ALDER] = TRAINER_PIC_ALDER,
    [FACILITY_CLASS_IRIS] = TRAINER_PIC_IRIS,
    [FACILITY_CLASS_ASH] = TRAINER_PIC_ASH,
    [FACILITY_CLASS_DIANTHA] = TRAINER_PIC_DIANTHA,
    [FACILITY_CLASS_LEON] = TRAINER_PIC_LEON,
    [FACILITY_CLASS_GEETA] = TRAINER_PIC_GEETA,
    [FACILITY_CLASS_ROTOM] = TRAINER_PIC_ROTOM,
    [FACILITY_CLASS_RENE] = TRAINER_PIC_RENE,
    [FACILITY_CLASS_OAK] = TRAINER_PIC_OAK,
    [FACILITY_CLASS_IONO] = TRAINER_PIC_IONO,
};
