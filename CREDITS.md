...
## More Sprites 
- [rh-hideout](https://github.com/rh-hideout/pokeemerald-expansion) - Pokémon Emerald Expansion (Used as base for the project)
- [ShinyDragonHunter](https://github.com/TeamAquasHideout/Team-Aquas-Asset-Repo) - Gary Oak (Overworld and Back Sprite)
- [spilledpizza](https://github.com/TeamAquasHideout/Team-Aquas-Asset-Repo) - Cynthia (Overworld Sprite)
- [FL](https://www.pokecommunity.com/threads/resource-requests.213154/post-8058665) - Cynthia (Base for Back Sprite)
- [aveontrainer](https://www.pokecommunity.com/threads/resource-requests.213154/post-8058665) - Alder (Overworld Sprite), Leon (Overworld Sprite)
- [Kasen](https://github.com/TeamAquasHideout/Team-Aquas-Asset-Repo) - Iris (Overworld and Front Sprite)
- [PKMNTrainerRick](https://www.deviantart.com/pkmntrainerrick) - Ash (Base for All Sprites)
- [Lolw3e932](https://www.deviantart.com/lolw3e932)- Diantha (Overworld Sprite)
- [Wolfang62](https://www.deviantart.com/wolfang62) - Leon (Base for Front Sprite)
- [RHcks](https://www.deviantart.com/rhcks) - Geeta (All Sprites)
- [ChakiKyogre2](https://www.deviantart.com/chakikyogre2) - Oak (Front Sprite)
- [Brumirage](https://www.deviantart.com/brumirage) - Iono (Base for Front Sprite)
- Pokemon FRLF - Gary Oak (Front Sprite), Lance (Front Sprite and Base for Overworld Sprite)
- Pokemon BWP - Lance (Overworld Sprite), Cynthia (Base for Front Sprite), Alder (Base for Front Sprite)
- Pokemon Keishou - Diantha (Front Sprite)
